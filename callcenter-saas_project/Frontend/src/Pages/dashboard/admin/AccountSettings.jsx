  ...
  const handleChangeEmail = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Email change error:', errorData)
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-4 max-w-md">
                  ...
                  {/* Email Change Button - Using inline styles to ensure visibility */}
                  <button
              ...
              <Card className="p-6">
                ...
                <div className="space-y-4 max-w-md">
                  ...
                  {/* Password Change Button - Using inline styles to ensure visibility */}
                  <button
